...
function Banner() {
  return (
    <>
      <div className="container gap-10 pt-20 mb-[-8%] md:gap-20 lg:gap-40 xl:gap-80 mt-12 max-w-screen-2xl mx-auto px-4 md:px-20 flex flex-col md:flex-row md:mt-30 ">
